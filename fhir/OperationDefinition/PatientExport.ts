...
export default {
    ...
    "url"  : `${config.baseUrl}/fhir/OperationDefinition/PatientExport`,
    "base" : "http://hl7.org/fhir/uv/bulkdata/OperationDefinition/patient-export",
    "version" : "2.0.0",
